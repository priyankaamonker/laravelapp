...
<div class="container content py-6 mx-auto">
    <div class="hover:shadow px-5 bg-white border-blue-500 border-t-2">
        <div class="container content py-6 mx-auto">
            <div class="flex">
                <h2 class="text-lg text-gray-800 mb-4">Edit User</h2>
            </div>   
            <div class="flex">
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="name" id="name" class="bg-gray-100  text-gray-800 text-sm rounded block w-full p-3" value="{{ $user->name }}">
                </div>
                <div class="mb-5">
                    <label for="password" class="block mb-3 text-sm font-medium text-gray-900 dark:text-black">*Password </label>
                    <input type="password" name="password" id="password" class="bg-gray-100  text-gray-800 text-sm rounded block w-full p-3" value="">
                </div>
                @if ($errors->any())
