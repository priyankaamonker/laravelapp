...
<div class="container content py-6 mx-auto">
    <div class="hover:shadow px-5 bg-white border-blue-500 border-t-2">
        <div class="container content py-6 mx-auto">
            <div class="flex">
                <h2 class="text-lg text-gray-800 mb-4">Create a New Post</h2>
            </div>   
            <div class="flex">
            <form action="{{ route('posts.store') }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <textarea name="content" id="content" class="bg-gray-100  text-gray-800 text-sm rounded block w-full p-3" rows="4" cols="50"></textarea>
                </div>
                @if ($errors->any())
                ...
                <a href="{{ url('/posts/') }}" class="px-4 py-3 bg-red-500 text-white font-semibold rounded hover:bg-red-600">Cancel</a>
            </form>
            </div>  
        </div>
    </div>
